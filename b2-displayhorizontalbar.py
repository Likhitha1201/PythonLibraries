""" 
    ...
    @Title: write a Python programming to display a horizontal bar chart of the popularity of programming Languages.  
...
def main():
    ...
    plt.barh(prg_lang, popularity, color='lightgreen')
    plt.show()
